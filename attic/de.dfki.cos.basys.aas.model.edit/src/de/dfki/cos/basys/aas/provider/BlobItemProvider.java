...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.aas.IBlob} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlobItemProvider 
	 ...
	 * @generated
	 */
	public BlobItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Blob_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Blob_value_feature", "_UI_Blob_type"),
				 IAasPackage.Literals.BLOB__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMimeTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Blob_mimeType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Blob_mimeType_feature", "_UI_Blob_type"),
				 IAasPackage.Literals.BLOB__MIME_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Blob"));
	}
	...
	public String getText(Object object) {
		String label = ((IBlob)object).getIdShort();
		return label == null || label.length() == 0 ?
			getString("_UI_Blob_type") :
			getString("_UI_Blob_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IBlob.class)) {
