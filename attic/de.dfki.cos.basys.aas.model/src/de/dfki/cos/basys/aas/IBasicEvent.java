 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.aas.IBasicEvent#getObserved <em>Observed</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.aas.IAasPackage#getBasicEvent()
 * @model
 * @generated
 */
public interface IBasicEvent extends IEvent {
	 ...
	 * @see de.dfki.cos.basys.aas.IAasPackage#getBasicEvent_Observed()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.aas.IBasicEvent#getObserved <em>Observed</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
