 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.FileImpl#getMimeType <em>Mime Type</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.FileImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FileImpl extends DataElementImpl implements File {
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AasPackage.FILE__VALUE, oldValue, value));
	}
