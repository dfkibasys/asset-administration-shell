 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getDataSpecification <em>Data Specification</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getIdShort <em>Id Short</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getCategory <em>Category</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getDescription <em>Description</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getParent <em>Parent</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getSemanticId <em>Semantic Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getKind <em>Kind</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getInputVariable <em>Input Variable</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getOutputVariable <em>Output Variable</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Operation#getInoutputVariable <em>Inoutput Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
