 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getDataSpecification <em>Data Specification</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getIdShort <em>Id Short</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getCategory <em>Category</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getDescription <em>Description</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getParent <em>Parent</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getAdministration <em>Administration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getIdentification <em>Identification</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getDerivedFrom <em>Derived From</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getSecurity <em>Security</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getAsset <em>Asset</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getSubmodel <em>Submodel</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getView <em>View</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.AssetAdministrationShell#getConceptDictionary <em>Concept Dictionary</em>}</li>
 * </ul>
 *
 * @generated
 */
