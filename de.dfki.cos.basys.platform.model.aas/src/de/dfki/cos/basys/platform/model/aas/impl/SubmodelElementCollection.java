 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getDataSpecification <em>Data Specification</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getIdShort <em>Id Short</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getCategory <em>Category</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getDescription <em>Description</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getParent <em>Parent</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getSemanticId <em>Semantic Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getKind <em>Kind</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#isAllowDuplicates <em>Allow Duplicates</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#isOrdered <em>Ordered</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.SubmodelElementCollection#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
