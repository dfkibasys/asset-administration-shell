 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getDataSpecification <em>Data Specification</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getSemanticId <em>Semantic Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getIdShort <em>Id Short</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getCategory <em>Category</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getDescription <em>Description</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getParent <em>Parent</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getAdministration <em>Administration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getIdentification <em>Identification</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getKind <em>Kind</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.impl.Submodel#getSubmodelElement <em>Submodel Element</em>}</li>
 * </ul>
 *
 * @generated
 */
