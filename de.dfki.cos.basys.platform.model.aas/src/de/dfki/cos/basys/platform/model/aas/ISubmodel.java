 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.aas.ISubmodel#getSubmodelElement <em>Submodel Element</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.aas.IAasPackage#getSubmodel()
 * @model
 * @generated
 */
public interface ISubmodel extends IHasDataSpecification, IHasSemantics, IIdentifiable, IQualifiable, IHasKind {
	 ...
	 * @see de.dfki.cos.basys.platform.model.aas.IAasPackage#getSubmodel_SubmodelElement()
