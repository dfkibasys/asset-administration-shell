...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.aas.IBasicEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BasicEventItemProvider 
	...
	protected void addObservedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BasicEvent_observed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BasicEvent_observed_feature", "_UI_BasicEvent_type"),
				 IAasPackage.Literals.BASIC_EVENT__OBSERVED,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((IBasicEvent)object).getIdShort();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IBasicEvent.class)) {
