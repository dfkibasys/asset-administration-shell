...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.aas.IMultiLanguageProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiLanguagePropertyItemProvider 
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultiLanguageProperty_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultiLanguageProperty_value_feature", "_UI_MultiLanguageProperty_type"),
				 IAasPackage.Literals.MULTI_LANGUAGE_PROPERTY__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IAasPackage.Literals.MULTI_LANGUAGE_PROPERTY__VALUE_ID);
		}
	...
	public String getText(Object object) {
		String label = ((IMultiLanguageProperty)object).getIdShort();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IMultiLanguageProperty.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IAasPackage.Literals.MULTI_LANGUAGE_PROPERTY__VALUE_ID,
				 IAasFactory.eINSTANCE.createReference()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == IAasPackage.Literals.MULTI_LANGUAGE_PROPERTY__VALUE_ID;
