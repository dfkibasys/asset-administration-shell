...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.aas.IAsset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssetItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAssetIdentificationModelPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IAasPackage.Literals.ASSET__KIND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Asset Identification Model feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAssetIdentificationModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Asset_assetIdentificationModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Asset_assetIdentificationModel_feature", "_UI_Asset_type"),
				 IAasPackage.Literals.ASSET__ASSET_IDENTIFICATION_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBillOfMaterialPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Asset_billOfMaterial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Asset_billOfMaterial_feature", "_UI_Asset_type"),
				 IAasPackage.Literals.ASSET__BILL_OF_MATERIAL,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((IAsset)object).getIdShort();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IAsset.class)) {
