...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.aas.IEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
	...
	protected void addStatementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_statement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_statement_feature", "_UI_Entity_type"),
				 IAasPackage.Literals.ENTITY__STATEMENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IAasPackage.Literals.ENTITY__ENTITY_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAssetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_asset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_asset_feature", "_UI_Entity_type"),
				 IAasPackage.Literals.ENTITY__ASSET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((IEntity)object).getIdShort();
