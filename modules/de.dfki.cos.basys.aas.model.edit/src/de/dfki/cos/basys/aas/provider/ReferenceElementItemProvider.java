...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.aas.IReferenceElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceElementItemProvider 
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceElement_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceElement_value_feature", "_UI_ReferenceElement_type"),
				 IAasPackage.Literals.REFERENCE_ELEMENT__VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((IReferenceElement)object).getIdShort();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IReferenceElement.class)) {
