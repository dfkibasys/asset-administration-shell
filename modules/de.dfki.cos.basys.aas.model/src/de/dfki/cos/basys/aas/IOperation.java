 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.aas.IOperation#getInputVariable <em>Input Variable</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.IOperation#getOutputVariable <em>Output Variable</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.IOperation#getInoutputVariable <em>Inoutput Variable</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.aas.IAasPackage#getOperation()
 * @model
 * @generated
 */
public interface IOperation extends ISubmodelElement {
	 ...
	 * The list contents are of type {@link de.dfki.cos.basys.aas.IOperationVariable}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Input Variable</em>' reference list.
	 * @see de.dfki.cos.basys.aas.IAasPackage#getOperation_InputVariable()
	 * @model
	 * @generated
	 */
	 ...
	 * @see de.dfki.cos.basys.aas.IAasPackage#getOperation_OutputVariable()
	 * @model
	 * @generated
	 */
	 ...
	 * @see de.dfki.cos.basys.aas.IAasPackage#getOperation_InoutputVariable()
	 * @model
	 * @generated
	 */
