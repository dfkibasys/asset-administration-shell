 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getDataSpecification <em>Data Specification</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getIdShort <em>Id Short</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getCategory <em>Category</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getDescription <em>Description</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getParent <em>Parent</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getSemanticId <em>Semantic Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getKind <em>Kind</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getValueType <em>Value Type</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getMin <em>Min</em>}</li>
 *   <li>{@link de.dfki.cos.basys.aas.impl.Range#getMax <em>Max</em>}</li>
 * </ul>
 *
 * @generated
 */
